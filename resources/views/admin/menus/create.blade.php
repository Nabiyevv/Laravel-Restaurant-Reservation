        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.menus.index') }}"
                    class="py-1.5 px-2 bg-slate-100 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-500 hover:bg-slate-300 rounded-lg">Menu
                    Index</a>
            </div>
            <div class="m-2 p-2 bg-slate-100 rounded dark:bg-gray-800">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-5 ">
                    <form method="POST" enctype="multipart/form-data ">
                        ...
                        <div class="sm:col-span-6 pb-5">
                            <label for="price" class="block text-sm font-medium text-gray-700 dark:text-white"> Price
                            </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 ">
                            <label for="default"
                                ...
                                <div class="mt-1">
                            <select id="default"
                                class="bg-gray-50 border border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
