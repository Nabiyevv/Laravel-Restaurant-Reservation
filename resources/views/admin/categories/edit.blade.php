        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.categories.index') }}"
                    class="py-1.5 px-2 bg-slate-100 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-500 hover:bg-slate-300 rounded-lg">Category
                    Index</a>
            </div>
                            ...
                            <div class="mt-1">
                                <textarea id="description" rows="3" name="description"
                                    class="dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                                     shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base
                                      leading-normal transition duration-150 ease-in-out focus:border-indigo-500 
